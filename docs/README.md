...
| [`external/python-best-practices-retrofit.md`](../docs/external/python-best-practices-retrofit.md) | Referencia externa: guía del Retrofit Chapter (MasOrange), origen del doc anterior |
