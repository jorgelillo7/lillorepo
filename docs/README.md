...
| Doc | What's in it |
|---|---|
| [`technical/backend/python-conventions.md`](technical/backend/python-conventions.md) | This repo's own Python rules, `LP-1` … `LP-24`: dependencies, layers, errors, tests — each with its motive and how it is checked |
