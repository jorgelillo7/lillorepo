...
| | What is missing | Waiting on |
|---|---|---|
| 🔨 | 16 behaviours stated in `openspec/` with no test (GAP blocks, most of them in `core`) | Nothing — ready for a test-hardening pass · `grep -rn "GAP — unverified" openspec/specs` |
