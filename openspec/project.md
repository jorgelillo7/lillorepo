...
| `be_water` | `web` | [`water-similarity`](specs/be_water/water-similarity/spec.md), [`provenance`](specs/be_water/provenance/spec.md), [`aesan-registry`](specs/be_water/aesan-registry/spec.md), [`community`](specs/be_water/community/spec.md), [`data-curation`](specs/be_water/data-curation/spec.md), [`photos`](specs/be_water/photos/spec.md), [`seo`](specs/be_water/seo/spec.md), [`identity-and-moderation`](specs/be_water/identity-and-moderation/spec.md), [`add-water`](specs/be_water/add-water/spec.md), [`label-ocr`](specs/be_water/label-ocr/spec.md) |
| `chucknorris_bot` | `bot` | [`chuck-jokes`](specs/chucknorris_bot/chuck-jokes/spec.md) Telegram bot |
| `core` | — | [`http-retry`](specs/core/http-retry/spec.md), [`gemini-client`](specs/core/gemini-client/spec.md), [`telegram-sdk`](specs/core/telegram-sdk/spec.md), [`biwenger-session`](specs/core/biwenger-session/spec.md), [`biwenger-reads`](specs/core/biwenger-reads/spec.md), [`biwenger-writes`](specs/core/biwenger-writes/spec.md), [`jp-predictions`](specs/core/jp-predictions/spec.md), [`oraculo-reader`](specs/core/oraculo-reader/spec.md), [`firestore-store`](specs/core/firestore-store/spec.md), [`league-records`](specs/core/league-records/spec.md), [`cloud-storage`](specs/core/cloud-storage/spec.md), [`sheets-workbook`](specs/core/sheets-workbook/spec.md), [`cloud-run-job-trigger`](specs/core/cloud-run-job-trigger/spec.md), [`web-request-guards`](specs/core/web-request-guards/spec.md), [`service-launcher`](specs/core/service-launcher/spec.md) |
