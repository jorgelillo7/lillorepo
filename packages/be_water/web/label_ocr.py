...
"registry_id" es el número del registro sanitario tal cual aparece
("RGSEAA 27.02231/BA" → "27.02231/BA"), null si no se ve. "bottler" es la
empresa envasadora ("Envasada por SONEPA" → "SONEPA"), null si no aparece;
no la confundas con la cadena de supermercado."""
...
LABEL_SCHEMA = {
    ...
    "properties": {
        ...
        "registry_id": {"type": "STRING", "nullable": True},
        "bottler": {"type": "STRING", "nullable": True},
...
def extract_label(image_bytes: bytes) -> dict:
    """Photo → {name, spring, province, community, sparkling, analysis_date,
    registry_id, bottler, minerals…}.
